/** @jsx jsx */
import { React, DataSourceManager, SessionManager, DataSource, DataSourceStatus, Immutable, getAppStore, DataSourceTypes, IMUrlParameters, IMState } from 'jimu-core';
...
export default class Widget extends React.PureComponent<AllWidgetProps<IMConfig> & ExtraProps, any>{
  ...
  updateStyle = () => {
    ...
    if (ua === 'safari') {
      const formNode = document.querySelector('#' + this.domId) as any;
