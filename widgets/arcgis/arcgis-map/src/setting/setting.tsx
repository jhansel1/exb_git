/** @jsx jsx */
import {React, Immutable, ImmutableObject, DataSourceJson, IMState, FormattedMessage,
  css, jsx, DataSourceManager, getAppStore, polished, classNames, UseDataSource} from 'jimu-core';
        ...
        <SettingSection title={this.props.intl.formatMessage({id: 'sourceLabel', defaultMessage: defaultMessages.sourceLabel})}>
          ...
          <SettingRow>
            <DataSourceSelector isMultiple={true} types={this.supportedDsTypes}
              ...
              disableSelection={this.onDisableSelection} mustUseDataSource={true} widgetId={this.props.id}
            />
          </SettingRow>
            ...
            <div className="d-flex justify-content-between w-100 align-items-center">
              <div className="align-items-center d-flex">
                ...
                <label className="m-0 ml-2" style={{cursor: 'pointer'}} onClick={() => this.handleIsUseCustomMapState(false)}
                  title={this.props.intl.formatMessage({id: 'defaultViewTip', defaultMessage: defaultMessages.defaultViewTip})}>
                  {this.props.intl.formatMessage({id: 'defaultView', defaultMessage: defaultMessages.defaultView})}</label>
              </div>
            </div>
          </SettingRow>
          <SettingRow>
            <div className="d-flex justify-content-between w-100 align-items-center">
              <div className="align-items-center d-flex">
                ...
                <label className="m-0 ml-2" style={{cursor: 'pointer'}} onClick={() => this.handleIsUseCustomMapState(true)}
                  title={this.props.intl.formatMessage({id: 'customViewTip', defaultMessage: defaultMessages.customViewTip})}>
                  {this.props.intl.formatMessage({id: 'customView', defaultMessage: defaultMessages.customView})}</label>
              </div>
            </div>
          </SettingRow>
        ...
        <SettingRow>
          <div className="w-100 webmap-tools">
            <div className="webmap-tools-item">
              ...
              <div>
                <ColorPicker style={{padding: '0'}} width={26} height={14} disableAlpha
                  color={this.props.config.selectionHighlightColor ? this.props.config.selectionHighlightColor : '#00FFFF'}
                  onChange={this.updateSelectionHighlightColor} presetColors={this.presetColors}></ColorPicker>
              </div>
            </div>
            <div className="webmap-tools-item">
