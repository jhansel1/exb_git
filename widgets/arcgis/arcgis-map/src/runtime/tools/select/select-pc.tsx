...
export class SelectPCTool extends React.PureComponent<Props, States>{
  ...
  render() {
    return <div css={this.getCSSStyle()}><div className="d-flex align-items-center justify-content-center select-tool-container" ref={ref => {this.btnContainer = ref;}}>
      <div className="d-flex">
        <div className="d-flex">
          <button onClick={this.toggleIsSelectActive}
          ...
          <button onClick={this.toggleSelectTypePopup} style={{width: 18}}
        ...
        <button className="select-tool-btn d-flex align-items-center justify-content-center select-tool-btn-hover esri-widget--button border-0"
          ...
          <div className="p-3 content-bg" style={{display: 'flex', flexDirection: 'column'}}>
            ...
            <div className="mt-2 mb-2">
              <div className="d-flex mb-2">
                <div className={classNames('select-tool-type mr-2 d-flex flex-column align-items-center justify-content-center select-tool-btn-hover', {
                  ...
                  <div className="select-tool-type-text mt-1 w-100 text-truncate pl-1 pr-1 d-flex justify-content-center"
                ...
                <div className={classNames('select-tool-type d-flex flex-column align-items-center justify-content-center select-tool-btn-hover', {
            ...
            <div>
              <div className="d-flex align-items-center mt-2">
                <Radio style={{cursor: 'pointer'}} checked={this.state.spatialRelationship === 'intersects'}
              ...
              <div className="d-flex align-items-center mt-2">
                <Radio style={{cursor: 'pointer'}} checked={this.state.spatialRelationship === 'contains'}
    ...
    {(this.state.isQuerying || !this.state.sketchInitialed) && <div className="select-tool-loader"></div>}
    </div>
  }
}