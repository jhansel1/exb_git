...
export default class Select extends BaseTool<BaseToolProps, SelectState> {
  ...
  getExpandPanel(): JSX.Element {
    if (this.props.isMobile) {
      return <SelectMobileTool isActive={this.toolName === (this.props.activeToolInfo && this.props.activeToolInfo.activeToolName)}
        ...
        theme={this.props.theme} intl={this.props.intl} jimuMapView={this.props.jimuMapView}></SelectMobileTool>;
    } else {
      return <SelectPCTool theme={this.props.theme} intl={this.props.intl} jimuMapView={this.props.jimuMapView}></SelectPCTool>;
    }
  }
}