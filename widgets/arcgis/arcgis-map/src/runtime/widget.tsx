/** @jsx jsx */
import { BaseWidget, appActions, css, jsx, getAppStore, AllWidgetProps, SessionManager,
  utils, AppMode, IMState, classNames, polished, ReactResizeDetector } from 'jimu-core';
...
import { portalUtils, JimuMapViewGroup } from 'jimu-arcgis';
      ...
      if (!(this.props.useDataSources && this.props.useDataSources[0] && this.props.useDataSources[0].dataSourceId)) {
          ...
          return <div className="jimu-widget" ref={ref => {this.parentContainer = ref; }}>
            <div css={this.getStyle()} className={'jimu-widget'}
              ...
              <div className={classNames('jimu-widget', {'map-is-design-mode': !checkIsLive(this.props.appMode)})}>
                {<MultiSourceMap fullScreenMap={this.fullScreenMap} baseWidgetProps={this.props} startLoadModules={this.state.startLoadModules} isDefaultMap
                  ref={this.setMultiSourceMapInstance} onViewGroupCreate={this.handleViewGroupCreate}
                  widgetHeight={this.state.widgetHeight} widthBreakpoint={this.state.widthBreakpoint}></MultiSourceMap>}
              </div>
        ...
        return <div className="jimu-widget" ref={ref => {this.parentContainer = ref; }}>
          <div css={this.getStyle()} className={'jimu-widget'}
            ref={ref => {this.container = ref; }}>
            <div className={classNames('jimu-widget', {'map-is-design-mode': !checkIsLive(this.props.appMode)})}>
              {<MultiSourceMap fullScreenMap={this.fullScreenMap} baseWidgetProps={this.props} startLoadModules={this.state.startLoadModules}
                ref={this.setMultiSourceMapInstance} onViewGroupCreate={this.handleViewGroupCreate}
                widgetHeight={this.state.widgetHeight} widthBreakpoint={this.state.widthBreakpoint}></MultiSourceMap>}
            </div>
            <ReactResizeDetector handleWidth handleHeight onResize={this.onResize}></ReactResizeDetector>
