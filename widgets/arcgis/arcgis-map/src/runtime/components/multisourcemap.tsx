...
import {MapViewManager, JimuMapView, JimuMapViewGroup, JimuMapViewComponent} from 'jimu-arcgis';
  ...
  render() {
    return <MultiSourceMapContext.Provider value = {{
      ...
      {this.state.currentJimuMapView && this.state.currentJimuMapView.view &&
        <Layout mapWidgetId={this.props.baseWidgetProps.id} isMobile={this.props.widthBreakpoint === 'xsmall'} jimuMapView={this.state.currentJimuMapView}
