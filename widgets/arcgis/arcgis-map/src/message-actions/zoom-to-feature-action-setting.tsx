/** @jsx jsx */
import {React, css, jsx, ActionSettingProps, SerializedStyles, ImmutableObject, DataSourceManager,
  themeUtils, ThemeVariables, polished, getAppStore, Immutable, UseDataSource, IMUseDataSource, MessageType} from 'jimu-core';
    ...
    return <div css={this.getStyle(this.props.theme)}>
      ...
      <SettingSection title={this.props.intl.formatMessage({id: 'mapZoomToAction_ZoomScale', defaultMessage: defaultMessages.mapZoomToAction_ZoomScale})}>
        <SettingRow>
          <div className="d-flex justify-content-between w-100 align-items-center">
            <div className="align-items-center d-flex">
              <Radio style={{cursor: 'pointer'}} checked={!this.props.config.isUseCustomZoomToOption}
        ...
        {this.props.config.isUseCustomZoomToOption && <SettingRow>
          <TextInput className="w-100" type="number" placeholder={this.props.intl.formatMessage({id: 'mapZoomToAction_TypeScale', defaultMessage: defaultMessages.mapZoomToAction_TypeScale})}
            value={this.props.config.zoomToOption && this.props.config.zoomToOption.scale}
            onChange={e => { this.handleSetCustomZoomScale(e.target.value) }}></TextInput>
        </SettingRow>}
      </SettingSection>
    </div>;
  }
