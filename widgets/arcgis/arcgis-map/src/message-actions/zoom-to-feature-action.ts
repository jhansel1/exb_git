import { AbstractMessageAction, MessageType, Message, getAppStore, DataRecordSetCreateMessage, DataRecordSetUpdateMessage,
  DataRecordsSelectionChangeMessage, FeatureDataRecord, ExtentChangeMessage, MutableStoreManager } from 'jimu-core';
    ...
    return loadArcGISJSAPIModules(['esri/Graphic']).then(modules => {
      ...
      switch(message.type){
        ...
        case MessageType.DataRecordSetUpdate:
          ...
          MutableStoreManager.getInstance().updateStateValue(this.widgetId, 'zoomToFeatureActionValue.value', updateFeatureSet);
          break;
