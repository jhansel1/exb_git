import { AbstractMessageAction, MessageType, Message, getAppStore, DataRecordSetCreateMessage, DataRecordSetUpdateMessage,
  DataRecordsSelectionChangeMessage, ExtentChangeMessage, FeatureDataRecord as FeatureQueryDataRecord, MutableStoreManager } from 'jimu-core';
    ...
    return loadArcGISJSAPIModules(['esri/Graphic']).then(modules => {
      ...
      switch(message.type){
        ...
        case MessageType.DataRecordSetUpdate:
          ...
          MutableStoreManager.getInstance().updateStateValue(this.widgetId, 'panToActionValue.value', updateFeatureSet);
          break;
