...
class RowLayout extends React.PureComponent<FlexboxLayoutProps & StateToLayoutProps> {
  ...
  onResize = (width, height) => {
    ...
    getAppStore().dispatch(appActions.widgetStatePropChange(this.props.widgetId, 'height', height));
  }
...
export default ReactRedux.connect<StateToLayoutProps, {}, FlexboxLayoutProps>(utils.mapStateToLayoutProps)(RowLayout);
