...
import {BoxShadowSetting, BorderSetting, FourSides, BackgroundSetting} from 'jimu-ui/advanced/style-setting-components';
    ...
    return (
      <div className="common-style-setting">
        ...
        <div className="mb-3">
          ...
          <SettingRow label={this.props.intl.formatMessage({id: 'corner', defaultMessage: jimuUIMessages.corner})} flow="wrap">
            <FourSides sides={borderSides} value={style.borderRadius} onChange={this.updateRadius} />
          </SettingRow>
        </div>
        <div className="mb-3">
