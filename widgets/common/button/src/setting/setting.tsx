/** @jsx jsx */
import {IMState, urlUtils, jsx, Immutable, IMThemeVariables, ImmutableArray, ExpressionPartType, IMIconResult, ThemeButtonType,
...
const supportedDsTypes = Immutable([AllDataSourceTypes.FeatureLayer, AllDataSourceTypes.FeatureQuery]);
            ...
            <SettingSection>
              ...
              >
                <Tabs fill pills onTabSelect={this.onAdvanceTabSelect}>
                  <Tab id="regular" defaultActive title={this.props.intl.formatMessage({id: 'regular', defaultMessage: jimuUIMessages.regular})}>
                  ...
                  <Tab id="hover" title={this.props.intl.formatMessage({id: 'hover', defaultMessage: jimuUIMessages.hover})}>
                    <AdvanceStyleSetting intl={this.props.intl} appTheme={this.props.appTheme}
