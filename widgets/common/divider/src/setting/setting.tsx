/** @jsx jsx */
import { classNames, ThemeVariables, css, jsx, IMThemeVariables, IMState, ReactRedux, polished } from 'jimu-core';
...
class _Setting extends BaseWidgetSetting<AllWidgetSettingProps<IMConfig> & CustomeProps & ExtraProps, State> {
  ...
  render() {
    ...
    const pointTitle = `${this.translate('start')} & ${this.translate('endpoints')}`;
    return (
      <div className={classNames(`${prefix}card-setting`, `${prefix}setting`)} css={this.getStyle(this.props.theme)} >
        ...
        <SettingSection title={pointTitle}  className="pt-0 start-end-point">
          ...
          <SettingRow label={this.translate('start')}>
            <div className="d-flex align-items-center">
              <PointStyleSelector intl={intl} value={pointStart?.pointStyle} isPointStart={true} onChange={(value: PointStyle) => {this.onPointStyleChange('pointStart', value)}} />
          ...
          <SettingRow label={this.translate('end')} >
            <div className="d-flex align-items-center">
              <PointStyleSelector intl={intl} value={pointEnd?.pointStyle} isPointStart={false} onChange={(value: PointStyle) => {this.onPointStyleChange('pointEnd', value)}}  />
...
export default ReactRedux.connect<ExtraProps, {}, CustomeProps>(mapStateToProps)(_Setting);