...
import { BaseWidgetSetting, AllWidgetSettingProps, getAppConfigAction, builderAppSync, templateUtils } from 'jimu-for-builder';
...
import { BackgroundSetting, BorderSetting, FourSides, BoxShadowSetting } from 'jimu-ui/advanced/style-setting-components';
import { Switch, Icon, BorderSides, Button, Collapse, defaultMessages as jimuUIDefaultMessages, Tooltip } from 'jimu-ui';
