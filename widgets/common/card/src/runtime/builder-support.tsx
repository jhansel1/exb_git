...
const widgetModules = {
  ...
  selectionInCard: (layoutInfo: LayoutInfo, id: string, appConfig: any, useCurrentSizeMode: boolean = true) => {
    ...
    if(useCurrentSizeMode){
      layoutItems = searchUtils.getLayoutItemsInWidgetByLayoutInfo(appConfig, layoutInfo, id, getAppStore().getState().browserSizeMode);
    }else {
      layoutItems = [];
      layoutItems.push(...searchUtils.getLayoutItemsInWidgetByLayoutInfo(appConfig, layoutInfo, id, BrowserSizeMode.Large))
      layoutItems.push(...searchUtils.getLayoutItemsInWidgetByLayoutInfo(appConfig, layoutInfo, id, BrowserSizeMode.Medium))
      layoutItems.push(...searchUtils.getLayoutItemsInWidgetByLayoutInfo(appConfig, layoutInfo, id, BrowserSizeMode.Small))
    }
