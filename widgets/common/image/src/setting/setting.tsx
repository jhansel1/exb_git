/** @jsx jsx */
import { IMState, ThemeVariables, SerializedStyles, ImmutableArray, IMUseDataSource,
  Immutable, ImmutableObject, urlUtils, css, jsx, Expression, UseDataSource, expressionUtils } from 'jimu-core';
  ...
  getStyle(theme: ThemeVariables): SerializedStyles{
    return css`
      .widget-setting-image {
        ...
        .border-selected {
          border: 2px solid ${theme.colors.palette.primary[700]} !important;
        }
                ...
                <Tab id="dynamicSource" active={(this.props.config.functionConfig.imgSourceType === ImgSourceType.ByDynamicUrl)}
                  ...
                  <div className="mt-3">
                    ...
                    && <DynamicUrlSetting dynamicUrlType={this.props.config.functionConfig.dynamicUrlType}
                      ...
                      useDataSourceForMainDataAndViewSelector={this.props.config.functionConfig.useDataSourceForMainDataAndViewSelector}
