...
export default class ToolTipSetting extends React.PureComponent<Props, {}>{
  ...
  getRenderContent = () => {
    if (this.props.useDataSourcesEnabled) {
          ...
          return <div className="w-100">
            <SettingRow flow="wrap">
              <div className="align-items-center d-flex">
                <Radio style={{cursor: 'pointer'}} onChange={() => this.props.onToolTipWithAttachmentNameChange(false)}
            ...
            {!this.props.toolTipWithAttachmentName && <SettingRow>
              <div className="w-100 d-flex justify-content-end">
                <div style={{width: '90%', position: 'relative'}}>
                  <ExpressionInput useDataSources={this.props.useDataSources} onChange={this.props.onToolTipExpChange} openExpPopup={this.props.openToolTipPopup}
            ...
            <SettingRow>
              <div className="align-items-center d-flex">
                <Radio style={{cursor: 'pointer'}} onChange={() => this.props.onToolTipWithAttachmentNameChange(true)}
                  checked={this.props.toolTipWithAttachmentName}/>
                <label className="m-0 ml-2" style={{cursor: 'pointer'}}
      ...
      return <div style={{width: '100%', position: 'relative'}}>
        <TextInput size="sm" style={{width: '100%'}} className="float-right" value={this.props.toolTipText}
  ...
  render() {
    return <SettingRow flow="wrap" label={this.props.intl.formatMessage({id: 'toolTip', defaultMessage: defaultMessages.toolTip})}>
