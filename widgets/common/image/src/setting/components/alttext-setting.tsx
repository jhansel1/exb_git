...
export default class AltTextSetting extends React.PureComponent<Props, {}>{
  ...
  getRenderContent = () => {
    if (this.props.useDataSourcesEnabled) {
          ...
          return <div className="w-100">
            <SettingRow flow="wrap">
              <div className="align-items-center d-flex">
                <Radio style={{cursor: 'pointer'}} onChange={() => this.props.onAltTextWithAttachmentNameChange(false)}
            ...
            {!this.props.altTextWithAttachmentName && <SettingRow>
              <div className="w-100 d-flex justify-content-end">
                <div style={{width: '90%', position: 'relative'}}>
                  <ExpressionInput useDataSources={this.props.useDataSources} onChange={this.props.onAltTextExpChange} openExpPopup={this.props.openAltTextPopup}
            ...
            <SettingRow>
              <div className="align-items-center d-flex">
                <Radio style={{cursor: 'pointer'}} onChange={() => this.props.onAltTextWithAttachmentNameChange(true)}
                  checked={this.props.altTextWithAttachmentName}/>
                <label className="m-0 ml-2" style={{cursor: 'pointer'}}
      ...
      return <div style={{width: '100%', position: 'relative'}}>
        <TextInput size="sm" style={{width: '100%'}} className="float-right" value={this.props.altTextText}
  ...
  render() {
    return <SettingRow flow="wrap" label={this.props.intl.formatMessage({id: 'altText', defaultMessage: defaultMessages.altText})}>
