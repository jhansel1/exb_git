define({
  ...
  omitInternalStyleTip: 'หากในแต่ละตัวกรอง มีเพียงส่วนคำสั่งเดียวที่ร้องขอค่า (หรือป้ายกำกับการแสดงผล) ตัวเลือกนี้จะช่วยให้คุณสามารถตัดสไตล์การเริ่มทำงานดังกล่าวออกได้ (รวมทั้งป้ายกำกับและไอคอน) แล้วแสดงเนื้อหาส่วนคำสั่งโดยตรง จากนั้นจึงใช้งานโดยอัตโนมัติ',
