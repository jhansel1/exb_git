    ...
    return (
      <div>
        <div css={this.getStyle()} className={`d-flex align-items-center ${className}`}>
          {isShowBackButton && <Button color="tertiary" className="search-back"  icon size="sm" onClick={evt => {this.props?.toggleSearchBoxVisible(false)}}  title={formatMessage('clearSearch')}>
